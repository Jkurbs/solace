  ...
  return (
    <DashboardThemeShell>
      ...
      <div className="mx-auto grid max-w-6xl gap-6 px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
        <section className="grid gap-6 rounded-lg border border-neutral-200 bg-white p-6 dark:border-neutral-800 dark:bg-[#0d0d0b] sm:p-8">
          <div className="grid gap-4 lg:grid-cols-[1fr_auto] lg:items-end">
            <div>
              <p className="text-sm font-medium text-neutral-500 dark:text-neutral-400">Internal</p>
              <h1 className="mt-2 text-4xl font-semibold tracking-normal text-neutral-950 dark:text-neutral-50 sm:text-5xl">
                Contract Inspector
              </h1>
            ...
            <div className="grid gap-2 text-sm text-neutral-600 dark:text-neutral-400 lg:text-right">
          ...
          <div className="grid gap-3 sm:grid-cols-3">
            <div className="rounded-md border border-neutral-200 bg-neutral-50 p-4 dark:border-neutral-800 dark:bg-neutral-950/40">
            ...
            <div className="rounded-md border border-neutral-200 bg-neutral-50 p-4 dark:border-neutral-800 dark:bg-neutral-950/40">
              ...
              <strong className="mt-1 block text-2xl font-semibold text-amber-700 dark:text-amber-100">{statusCounts.mock}</strong>
            </div>
            <div className="rounded-md border border-neutral-200 bg-neutral-50 p-4 dark:border-neutral-800 dark:bg-neutral-950/40">
              <span className="text-sm text-neutral-500">Live</span>
              <strong className="mt-1 block text-2xl font-semibold text-emerald-700 dark:text-emerald-200">{statusCounts.live}</strong>
            </div>
          </div>
        </section>

        <section className="grid gap-5 lg:grid-cols-[18rem_1fr]">
          <aside className="grid content-start gap-3 rounded-lg border border-neutral-200 bg-white p-5 dark:border-neutral-800 dark:bg-[#0d0d0b]">
            <div>
              <p className="text-sm font-medium text-neutral-500 dark:text-neutral-400">Owner Services</p>
              <h2 className="mt-1 text-base font-semibold text-neutral-950 dark:text-neutral-50">Backend map</h2>
            </div>
            <div className="grid gap-2">
              {ownerCounts.map((owner) => (
                <div
                  key={owner.ownerLabel}
                  className="grid grid-cols-[1fr_auto] items-center gap-3 border-t border-neutral-200 py-3 first:border-t-0 first:pt-0 dark:border-neutral-800"
                >
                  <span className="text-sm text-neutral-700 dark:text-neutral-300">{owner.ownerLabel}</span>
                  <span className="rounded-full border border-neutral-300 px-2 py-0.5 text-xs text-neutral-500 dark:border-neutral-700 dark:text-neutral-400">
                    {owner.count}
                  </span>
                </div>
              ))}
          ...
          <section className="grid gap-3" aria-label="Dashboard contract fields">
            ...
            {snapshot.fieldSources.map((source) => (
              <article
                key={source.field}
                className="grid gap-4 rounded-lg border border-neutral-200 bg-white p-4 dark:border-neutral-800 dark:bg-[#0d0d0b] lg:grid-cols-[0.9fr_1fr_0.75fr_0.45fr_1.35fr] lg:items-start"
              >
                <div>
                  <span className="block text-xs font-medium uppercase tracking-[0.14em] text-neutral-500 lg:hidden">
                    Dashboard Field
                  </span>
                  <strong className="mt-1 block text-sm font-semibold text-neutral-950 dark:text-neutral-50 lg:mt-0">{source.label}</strong>
                ...
                <div>
                  ...
                  <p className="mt-1 line-clamp-3 text-sm leading-6 text-neutral-700 dark:text-neutral-300 lg:mt-0">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-neutral-700 dark:text-neutral-300 lg:mt-0">{source.ownerLabel}</p>
                </div>
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm leading-6 text-neutral-600 dark:text-neutral-400 lg:mt-0">{source.requirement}</p>
                </div>
              </article>
            ))}
          </section>
