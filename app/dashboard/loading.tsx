    ...
    <DashboardThemeShell>
      <header className="sticky top-0 z-30 border-b border-neutral-200 bg-[#f7f5ef]/90 backdrop-blur dark:border-neutral-800 dark:bg-[#0a0a0a]/90">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
          <div className="inline-flex items-center gap-2 text-sm font-bold text-neutral-950 dark:text-neutral-50">
            <Mark size={22} />
            Solace
          </div>
      ...
      <div className="mx-auto grid max-w-6xl gap-5 px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
        <section className="rounded-lg border border-neutral-200 bg-white p-6 dark:border-neutral-800 dark:bg-[#0d0d0b] sm:p-8">
          <div className="h-4 w-32 animate-pulse rounded bg-neutral-200 dark:bg-neutral-800" />
          <div className="mt-4 h-14 w-64 animate-pulse rounded bg-neutral-200 dark:bg-neutral-800 sm:h-16 sm:w-96" />
        ...
        <div className="grid gap-5 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="h-72 rounded-lg border border-neutral-200 bg-white dark:border-neutral-800 dark:bg-[#0d0d0b]" />
          <div className="h-72 rounded-lg border border-neutral-200 bg-white dark:border-neutral-800 dark:bg-[#0d0d0b]" />
        </div>
      </div>
    </DashboardThemeShell>
