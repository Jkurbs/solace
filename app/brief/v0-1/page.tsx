...
// Archived verbatim from Technical Brief V0.1 (June 2026). Do not edit the
...
export default function BriefV01Page() {
  return (
    <main className="brief-paper relative min-h-screen overflow-x-hidden pt-16">
      ...
      <article className="mx-auto max-w-4xl px-5 pb-24 pt-12 md:px-8">
        ...
        <div className="mt-20 flex flex-col gap-3 border-t border-[var(--paper-line)] pt-6 md:flex-row md:items-center md:justify-between">
          <p className="footer-fineprint font-mono text-[0.62rem] uppercase tracking-[0.18em] text-[var(--paper-muted)]">
            © 2026 Solace · Technical Brief V0.1 · Archived
          </p>
          <Link
            href="/brief"
